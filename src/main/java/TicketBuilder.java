...
public class TicketBuilder {
     ...
     */
    public static final String SRC = "src/main/resources/assets/TemplateTicketIcon.pdf";
    /**
     * SRCVO contiene il percorso del template per il voucher (generato dopo un rimborso).
     */
    public static final String SRCVO = "src/main/resources/assets/TemplateVoucher.pdf";
    /**
     * SRCVOR contiene il percorso del template per il voucher regalo (o gift card) acquistabile dalla sezione apposita.
     */
    public static final String SRCVOR = "src/main/resources/assets/TemplateGiftCard.pdf";
    ...
    public void createPdf() throws Exception {
        if (this.id.startsWith("CS"))
            createCS();
        if (this.id.startsWith("VO"))
            createVO();
        else if (this.id.startsWith("VOR"))
            createVORegalo();
    }
     ...
     * @throws Exception
     */
    private void createCS() throws Exception {
     ...
     * @throws Exception
     */
    private void createVO() throws Exception {
     ...
     * @throws Exception
     */
    private void createVORegalo() throws Exception {
